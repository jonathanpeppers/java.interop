...
namespace MonoDroid.Generation
{
	...
	internal static class ManagedExtensions
	{
		...
		{
			return m.HasGenericParameters ? GenericParameterDefinitionList.FromMetadata (m.GenericParameters) : null;
		}
		...
		{
			return m.IsPublic ? "public" : m.IsFamilyOrAssembly ? "protected internal" : m.IsFamily ? "protected" : m.IsAssembly ? "internal" : "private";
		}
